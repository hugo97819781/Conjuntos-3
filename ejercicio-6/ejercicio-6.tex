...
\thispagestyle{plain}
       ...
       \end{center}
        ...
        \textbf{\itshape Instrucciones.} {\itshape Esta tarea es \textbf{individual y presencial}, se entregará el día \textbf{lunes 11 de mayo} durante la clase.} \vspace{.25cm}
