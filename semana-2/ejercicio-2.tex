...
\begin{document}
    ...
    \begin{ejercicio}{10}
        Sea $\mathbb{P}=(P,\leq)$ un orden parcial y $G \subseteq P$ un filtro de $\mathbb{P}$. Pruebe que $G$ es un filtro genérico si y sólo si para toda anticadena maaximal $A$ de $\mathbb{P}$, $A \cap G \neq \emptyset$.
    \end{ejercicio}
