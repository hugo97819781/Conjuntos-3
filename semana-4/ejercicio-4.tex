...
\thispagestyle{plain}
       ...
       \textit{\textbf{\textsc{Instrucciones.}} Esta tarea es \textbf{individual} y deberá ser entregada \textbf{presencial y personalmente} el día \textbf{viernes 20 de marzo} al inicio la clase.}\vspace{.3cm}

    \begin{ejercicio}{5}
        Sean $(B, \leq)$ y $(B', \preccurlyeq)$ álgebras de Boole y supóngase que $X \subseteq B$ y $X' \subseteq B'$ son densos, en $B$ y $B'$, respectivamente. Pruebe que si $(X,\leq) \cong (X',\preccurlyeq)$, entonces $B$ y $B'$ son isomorfas.
    \end{ejercicio}
